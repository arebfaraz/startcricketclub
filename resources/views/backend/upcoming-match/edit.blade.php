        ...
        <div class="page-inner">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="card-title">Update Upcoming Match</h4>
                    <a href="{{ url()->previous() }}" class="btn btn-icon btn-round btn-primary">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('upcoming-match.update', $match->id) }}" method="post"
                                    ...
                                    <select name="team_1_id" id="team_1_id" class="form-control select2">
                                        ...
                                        @foreach ($teams as $team)
                                            <option value="{{ $team->id }}"
                                                {{ old('team_1_id', $match->team_1_id) == $team->id ? 'selected' : '' }}>
                                                {{ $team->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('team_2_id') has-error  @enderror">
                                    ...
                                    <select name="team_2_id" id="team_2_id" class="form-control select2">
                                        ...
                                        @foreach ($teams as $team)
                                            <option value="{{ $team->id }}"
                                                {{ old('team_2_id', $match->team_2_id) == $team->id ? 'selected' : '' }}>
                                                {{ $team->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('type') has-error  @enderror">
                                    ...
                                    <select name="type" id="type" class="form-control form-control-sm">
                                        ...
                                        <option value="T20 Match"
                                            {{ old('type', $match->type) == 'T20 Match' ? 'selected' : '' }}>
                                            T20 Match
                                        </option>
                                        <option value="One Day Match"
                                            {{ old('type', $match->type) == 'One Day Match' ? 'selected' : '' }}>
                                            One Day Match
                                        </option>
                                        <option value="Test Match"
                                            {{ old('type', $match->type) == 'Test Match' ? 'selected' : '' }}>
                                            Test Match
                                        </option>
                                    </select>
                                    @error('type')
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('date') has-error  @enderror">
                                    ...
                                    <input type="date" name="date" class="form-control form-control-sm "
                                        id="date" value="{{ old('date', $match->date) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('time') has-error  @enderror">
                                    ...
                                    <input type="time" name="time" class="form-control form-control-sm "
                                        id="time" value="{{ old('time', $match->time) }}">
                                    @error('time')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
