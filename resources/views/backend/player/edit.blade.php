                                    ...
                                    <select name="nationality" id="nationality" class="form-control select2">
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country['name'] }}"
                                                {{ old('nationality', $player->nationality) == $country['name'] ? 'selected' : '' }}>
                                                {{ $country['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group  @error('status_in_cambodia') has-error  @enderror">
                                    ...
                                    <select name="status_in_cambodia" class="form-control select2"
                                        ...
                                        <option value="Buisness Visa"
                                            {{ old('status_in_cambodia', $player->status_in_cambodia) == 'Buisness Visa' ? 'selected' : '' }}>
                                            Buisness
                                            Visa</option>
                                        <option value="Tourist Visa"
                                            {{ old('status_in_cambodia', $player->status_in_cambodia) == 'Tourist Visa' ? 'selected' : '' }}>
                                            Tourist
                                            Visa</option>
                                        <option value="Other"
                                            {{ old('status_in_cambodia', $player->status_in_cambodia) == 'Other' ? 'selected' : '' }}>
                                            Other
                                        </option>
                                    </select>
                                ...
                                <div class="form-group @error('city') has-error  @enderror">
                                    ...
                                    <select name="city" class="form-control select2" id="city">
                                        ...
                                        <option value="Phnom Penh"
                                            {{ old('city', $player->city) == 'Phnom Penh' ? 'selected' : '' }}>
                                            Phnom Penh
                                        </option>
                                        <option value="Seim Reap"
                                            {{ old('city', $player->city) == 'Seim Reap' ? 'selected' : '' }}>
                                            Siem Reap
                                        </option>
                                        <option value="Battambong"
                                            {{ old('city', $player->city) == 'Battambong' ? 'selected' : '' }}>
                                            Battambong
                                        </option>
                                        <option value="Sihanoukville"
                                            {{ old('city', $player->city) == 'Sihanoukville' ? 'selected' : '' }}>
                                            Sihanoukville
                                        </option>

                                        <option value="Other"
                                            {{ old('city', $player->city) == 'Other' ? 'selected' : '' }}>
                                            Other
                                        </option>
                                    </select>
                                    @error('city')
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('jersey_size') has-error  @enderror">
                                    ...
                                    <select name="jersey_size" class="form-control select2" id="jersey_size">
                                        <option value="">Select</option>
                                        <option value="S"
                                            {{ old('jersey_size', $player->jersey_size) == 'S' ? 'selected' : '' }}>
                                            S
                                        </option>
                                        <option value="M"
                                            {{ old('jersey_size', $player->jersey_size) == 'M' ? 'selected' : '' }}>
                                            M
                                        </option>
                                        <option value="L"
                                            {{ old('jersey_size', $player->jersey_size) == 'L' ? 'selected' : '' }}>
                                            L
                                        </option>
                                        <option value="XL"
                                            {{ old('jersey_size', $player->jersey_size) == 'XL' ? 'selected' : '' }}>
                                            XL
                                        </option>

                                        <option value="XXL"
                                            {{ old('jersey_size', $player->jersey_size) == 'XXL' ? 'selected' : '' }}>
                                            XXL
                                        </option>
                                    </select>
                                    @error('jersey_size')
